...
def train_model(model_name):
	...
	if name=='customer_bn':
		...
		checkpoint = ModelCheckpoint(filepath='/Users/nex03343/Desktop/CS231N/project/model_customer_custom.hdf5', monitor='val_acc',\
									verbose=1, save_best_only=True, mode='max')
		csv_logger = CSVLogger('/Users/nex03343/Desktop/CS231N/project/training_customer_custom.log')
...
model=create_model('customer_bn')
history=train_model((model,'customer_bn'))
