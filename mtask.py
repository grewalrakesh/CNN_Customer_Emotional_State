...
model = Sequential()
model.add(Conv2D(32, kernel_size=(3, 3), input_shape=(img_rows, img_cols,3)))
model.add(Activation('relu'))
model.add(MaxPooling2D(pool_size=(2, 2)))
...
csv_logger=CSVLogger('/Users/nex03343/Desktop/CS231N/project/training_mt_custom.log')
filepath='/Users/nex03343/Desktop/CS231N/project/model_mt_custom.hdf5'
...
history=model.fit(x_train,y_train, 
	...
	shuffle=True,
	verbose=1, 
	validation_data=(x_val,y_val),callbacks=[csv_logger,checkpoint])
